/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d85b0cb65ff4521310ca7b141a3c4a26)
// Runtime types generated with workerd@1.20251210.0 2025-12-25 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "EGDataAgent";
	}
	interface Env {
		MISTRAL_API_KEY: string;
		GOOGLE_GENERATIVE_AI_API_KEY: string;
		EGDataAgent: DurableObjectNamespace<import("./src/index").EGDataAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MISTRAL_API_KEY" | "GOOGLE_GENERATIVE_AI_API_KEY">> {}
}
